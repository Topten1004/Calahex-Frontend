...
import Searcher from "../../../components/Wallets/ExchangeAccount/NewSearchTable";
import SearchUiTable from "../../../components/Wallets/ExchangeAccount/SearchUiTable";
import {Button} from "@material-ui/core";
import VisibilityOffOutlinedIcon from "@material-ui/icons/VisibilityOffOutlined";
import VisibilityOutlinedIcon from "@material-ui/icons/VisibilityOutlined";
import Grid from "@material-ui/core/Grid";
import Collapse from "@material-ui/core/Collapse";
import {ExchangeWalletInfo, ExchangeFiatDepositCheck} from "../../../redux/actions/wallet"
...
const Wallet = (props) => {
    ...
    const {selectLanding, isAuthenticated,user_id, exchangeWalletInfo,exchangeWalletAmount,exchangeWalletAmountBTC} = props;
    ...
    if(key!=null)
        props.ExchangeFiatDepositCheck(key);
                ...
                <div className={classes.mainBody}>
                    <div className={classes.main}>
                            ...
                            <div className={classes.balanceDiv}>
                                ...
                                <div className={classes.balanceBody}>
                                    <Grid container direction="row"
                                          ...
                                          alignItems="center">
                                        <Grid>
                                            <Typography className={classes.balanceText}>{coinValue=='USDT'?exchangeWalletAmount:exchangeWalletAmountBTC}</Typography>
                                        </Grid>
                                        <Select
                        ...
                        <div className={classes.chartPart}>
                            ...
                            {/*    <TopSearch/>*/}
                            {/*</div>*/}
                                <SearchUiTable rows ={exchangeWalletInfo}/>
                            {/*<Searcher/>*/}
                        </div>
                    </div>
                </div>
...
const mapStateToProps = state => ({
    ...
    exchangeWalletAmount: state.wallet.exchangeWalletAmount,
    exchangeWalletAmountBTC: state.wallet.exchangeWalletAmountBTC
});

const mapDispatchToProps = {
    ExchangeWalletInfo,
    ExchangeFiatDepositCheck
};
