...
import { UserProfile1 } from '../../redux/actions/auth';
import ProfileChangeForm from '../../components/Auth/ProfileChangeForm';
      ...
      <Grid container space={1}>
        ...
        <Grid item xs={10} sm={6} md={6}>
          <div className={classes.formContainer}>
            ...
            <ProfileChangeForm onSubmit={props.UserProfile1} error={props.error} />
          </div>
        </Grid>
      </Grid>
    </div>
