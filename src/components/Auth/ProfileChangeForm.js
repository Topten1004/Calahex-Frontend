...
const Form = (props) => {
  ...
  useEffect(() => {
    if (props.user_profile.status == 1) {

      setFormState(formState => ({
        ...formState,
        values: {
          ...formState.values,
          first_name: props.user_profile.data.firstname,
          last_name: props.user_profile.data.lastname,
          country: props.user_profile.data.country,
          city: props.user_profile.data.city,
          street: props.user_profile.data.street,
          postal_code: props.user_profile.data.postal_code,
          birthday: props.user_profile.data.birthday,
          // phone: props.user_profile.data.phone_number,
          language: props.user_profile.data.language,
          api_enabled: props.user_profile.data.api_enabled,
          nick_name: props.user_profile.data.nick_name,
          mother_name: props.user_profile.data.mother_name,
          father_name: props.user_profile.data.father_name,
          hobby: props.user_profile.data.hobby,
          best_friend: props.user_profile.data.best_friend,
        },
      }));
    }
  }, [props.user_profile])
  ...
  const handleSubmit = event => {
    ...
    if (formState.isValid) {
      ...
      formState.values.user_id = props.user_id;
      formState.values.change_state = formState.values.api_enabled === 0 ? false : (formState.values.api_enabled === props.user_profile.data.api_enabled)
